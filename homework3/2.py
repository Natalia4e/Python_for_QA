...
# убираем символы и делим на слова
word_without_symbol = re.findall(r'\b\w+\b', my_text.lower())
word_without_symbol.sort()
print(word_without_symbol)
#сколько раз встречается каждое слово
word_with_count = collections.Counter(word_without_symbol)
print(word_with_count)
#топ 10
top_10 = word_with_count.most_common(10)
print(top_10)
